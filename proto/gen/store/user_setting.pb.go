...
const (
	...
	// The user's optional personal profile for private, user-owned context.
	UserSetting_PERSONA UserSetting_Key = 9
)
...
func (x *UserSetting) GetPersona() *PersonaUserSetting {
	if x != nil {
		if x, ok := x.Value.(*UserSetting_Persona); ok {
			return x.Persona
		}
	}
	return nil
...
type UserSetting_Persona struct {
	Persona *PersonaUserSetting `protobuf:"bytes,11,opt,name=persona,proto3,oneof"`
}
...
func (*UserSetting_Persona) isUserSetting_Value() {}
...
// PersonaUserSetting stores the user's optional personal profile. It is kept
// in user settings so it follows the same backup and ownership model as other
// user-level preferences.
type PersonaUserSetting struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PersonaUserSetting) Reset() {
	*x = PersonaUserSetting{}
	mi := &file_store_user_setting_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PersonaUserSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PersonaUserSetting) ProtoMessage() {}

func (x *PersonaUserSetting) ProtoReflect() protoreflect.Message {
	mi := &file_store_user_setting_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PersonaUserSetting.ProtoReflect.Descriptor instead.
func (*PersonaUserSetting) Descriptor() ([]byte, []int) {
	return file_store_user_setting_proto_rawDescGZIP(), []int{4}
}

func (x *PersonaUserSetting) GetHeadline() string {
	if x != nil {
		return x.Headline
	}
	return ""
...
func (x *PersonaUserSetting) GetPreferredAddress() string {
	if x != nil {
...
func (x *PersonaUserSetting) GetCommunicationStyle() string {
	if x != nil {
...
func (x *PersonaUserSetting) GetInterestTags() []string {
	if x != nil {
...
func (x *PersonaUserSetting) GetRoutinePreferences() string {
	if x != nil {
...
func (x *PersonaUserSetting) GetLifeStage() string {
	if x != nil {
		return x.LifeStage
	}
	return ""
...
func (x *PersonaUserSetting) GetGoals() []string {
	if x != nil {
		return x.Goals
	}
	return nil
...
func (*RefreshTokensUserSetting_ClientInfo) Descriptor() ([]byte, []int) {
	return file_store_user_setting_proto_rawDescGZIP(), []int{5, 1}
}
...
const file_store_user_setting_proto_rawDesc = "" +
	"\n" +
	"\x18store/user_setting.proto\x12\vmemos.store\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/type/color.proto\"\xd4\x05\n" +
	...
	"\x04tags\x18\n" +
	" \x01(\v2\x1c.memos.store.TagsUserSettingH\x00R\x04tags\x12;\n" +
	"\apersona\x18\v \x01(\v2\x1f.memos.store.PersonaUserSettingH\x00R\apersona\"\x8b\x01\n" +
	"\x03Key\x12\x13\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x1c.memos.store.UserTagMetadataR\x05value:\x028\x01\"\x99\x02\n" +
	"\x12PersonaUserSetting\x12\x1a\n" +
	"\bheadline\x18\x01 \x01(\tR\bheadline\x12+\n" +
	"\x11preferred_address\x18\x02 \x01(\tR\x10preferredAddress\x12/\n" +
	"\x13communication_style\x18\x03 \x01(\tR\x12communicationStyle\x12#\n" +
	"\rinterest_tags\x18\x04 \x03(\tR\finterestTags\x12/\n" +
	"\x13routine_preferences\x18\x05 \x01(\tR\x12routinePreferences\x12\x1d\n" +
	"\n" +
	"life_stage\x18\x06 \x01(\tR\tlifeStage\x12\x14\n" +
	"\x05goals\x18\a \x03(\tR\x05goals\"\xa4\x04\n" +

...
type UserSetting_GeneralSetting_PersonalFeaturePrivacy int32

const (
	UserSetting_GeneralSetting_VISIBLE   UserSetting_GeneralSetting_PersonalFeaturePrivacy = 0
	UserSetting_GeneralSetting_BLURRED   UserSetting_GeneralSetting_PersonalFeaturePrivacy = 1
	UserSetting_GeneralSetting_COLLAPSED UserSetting_GeneralSetting_PersonalFeaturePrivacy = 2
)

// Enum value maps for UserSetting_GeneralSetting_PersonalFeaturePrivacy.
var (
	UserSetting_GeneralSetting_PersonalFeaturePrivacy_name = map[int32]string{
		0: "VISIBLE",
		1: "BLURRED",
		2: "COLLAPSED",
	}
	UserSetting_GeneralSetting_PersonalFeaturePrivacy_value = map[string]int32{
		"VISIBLE":   0,
		"BLURRED":   1,
		"COLLAPSED": 2,
	}
...
func (x UserSetting_GeneralSetting_PersonalFeaturePrivacy) Enum() *UserSetting_GeneralSetting_PersonalFeaturePrivacy {
	p := new(UserSetting_GeneralSetting_PersonalFeaturePrivacy)
	*p = x
	return p
}

func (x UserSetting_GeneralSetting_PersonalFeaturePrivacy) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (UserSetting_GeneralSetting_PersonalFeaturePrivacy) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_user_service_proto_enumTypes[2].Descriptor()
}

func (UserSetting_GeneralSetting_PersonalFeaturePrivacy) Type() protoreflect.EnumType {
	return &file_api_v1_user_service_proto_enumTypes[2]
}

func (x UserSetting_GeneralSetting_PersonalFeaturePrivacy) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use UserSetting_GeneralSetting_PersonalFeaturePrivacy.Descriptor instead.
func (UserSetting_GeneralSetting_PersonalFeaturePrivacy) EnumDescriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{13, 0, 0}
}
...
type UserSetting_GeneralSetting struct {
	...
	DisableReminders bool `protobuf:"varint,6,opt,name=disable_reminders,json=disableReminders,proto3" json:"disable_reminders,omitempty"`
	DisableFinance   bool `protobuf:"varint,7,opt,name=disable_finance,json=disableFinance,proto3" json:"disable_finance,omitempty"`
	DisableMood      bool `protobuf:"varint,8,opt,name=disable_mood,json=disableMood,proto3" json:"disable_mood,omitempty"`
	// How personal panels are presented when Home first loads.
	PersonalFeaturePrivacy UserSetting_GeneralSetting_PersonalFeaturePrivacy `protobuf:"varint,9,opt,name=personal_feature_privacy,json=personalFeaturePrivacy,proto3,enum=memos.api.v1.UserSetting_GeneralSetting_PersonalFeaturePrivacy" json:"personal_feature_privacy,omitempty"`
	// Require the account password before revealing private or blurred content.
	RequirePasswordForPrivateContent bool `protobuf:"varint,10,opt,name=require_password_for_private_content,json=requirePasswordForPrivateContent,proto3" json:"require_password_for_private_content,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
func (x *UserSetting_GeneralSetting) GetDisableReminders() bool {
	if x != nil {
...
func (x *UserSetting_GeneralSetting) GetDisableFinance() bool {
	if x != nil {
...
func (x *UserSetting_GeneralSetting) GetDisableMood() bool {
	if x != nil {
...
func (x *UserSetting_GeneralSetting) GetPersonalFeaturePrivacy() UserSetting_GeneralSetting_PersonalFeaturePrivacy {
	if x != nil {
		return x.PersonalFeaturePrivacy
	}
	return UserSetting_GeneralSetting_VISIBLE
}

func (x *UserSetting_GeneralSetting) GetRequirePasswordForPrivateContent() bool {
	if x != nil {
...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x05stats\x18\x01 \x03(\v2\x17.memos.api.v1.UserStatsR\x05stats\"\xae\x0e\n" +
	...
	"\x0fpersona_setting\x18\a \x01(\v2(.memos.api.v1.UserSetting.PersonaSettingH\x00R\x0epersonaSetting\x1a\xcb\x04\n" +
	...
	"\x13save_media_metadata\x18\x05 \x01(\bB\x03\xe0A\x01R\x11saveMediaMetadata\x120\n" +
	"\x11disable_reminders\x18\x06 \x01(\bB\x03\xe0A\x01R\x10disableReminders\x12,\n" +
	"\x0fdisable_finance\x18\a \x01(\bB\x03\xe0A\x01R\x0edisableFinance\x12&\n" +
	"\fdisable_mood\x18\b \x01(\bB\x03\xe0A\x01R\vdisableMood\x12~\n" +
	"\x18personal_feature_privacy\x18\t \x01(\x0e2?.memos.api.v1.UserSetting.GeneralSetting.PersonalFeaturePrivacyB\x03\xe0A\x01R\x16personalFeaturePrivacy\x12S\n" +
	"$require_password_for_private_content\x18\n" +
	" \x01(\bB\x03\xe0A\x01R requirePasswordForPrivateContent\"A\n" +
	"\x16PersonalFeaturePrivacy\x12\v\n" +
	"\aVISIBLE\x10\x00\x12\v\n" +
	"\aBLURRED\x10\x01\x12\r\n" +
	"\tCOLLAPSED\x10\x02\x1ay\n" +
	"\vTagMetadata\x12B\n" +

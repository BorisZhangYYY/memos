...
const file_api_v1_memo_service_proto_rawDesc = "" +
	...
	"createTime:X\xeaAU\n" +
	"\x15memos.api.v1/Reaction\x12!memos/{memo}/reactions/{reaction}\x1a\x04name*\treactions2\breaction\"\xdd\b\n" +
	"\x04Memo\x12\x17\n" +
	...
	"\n" +
	"mood_level\x18\x13 \x01(\x05R\tmoodLevel\x1a\xac\x01\n" +
	"\bProperty\x12\x19\n" +

...
func TestMigrationSpaceMemberStatusBackfillsActive(t *testing.T) {
	...
	require.NoError(t, err)
	basicSetting.SchemaVersion = "0.36.4"
...
func TestConcurrentInstanceAccessInitializationKeepsFirstInsert(t *testing.T) {
	...
	publicProfile := profile.Profile{Port: baseProfile.Port, Data: baseProfile.Data, DSN: baseProfile.DSN, Driver: baseProfile.Driver, Version: baseProfile.Version}
	...
	privateProfile := profile.Profile{Port: baseProfile.Port, Data: baseProfile.Data, DSN: baseProfile.DSN, Driver: baseProfile.Driver, Version: baseProfile.Version}

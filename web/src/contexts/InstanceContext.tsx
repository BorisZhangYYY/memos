      ...
      setState((prev) => ({
        ...
        profile:
          updatedSetting.value.case === "accessSetting"
            ...
            : updatedSetting.value.case === "generalSetting" && updatedSetting.value.value.instanceUrl !== undefined
              ? create(InstanceProfileSchema, { ...prev.profile, instanceUrl: updatedSetting.value.value.instanceUrl })
              : prev.profile,

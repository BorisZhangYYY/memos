...
export type UserStats = Message<"memos.api.v1.UserStats"> & {
   ...
   *
   * @generated from field: map<string, float> daily_mood_stats = 9;
   */
  dailyMoodStats: { [key: string]: number };
